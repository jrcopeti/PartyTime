...
ActiveRecord::Schema[7.0].define(version: 2023_03_16_200237) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "event_id"
    t.string "devise", default: [], array: true
  ...
  add_foreign_key "events", "devise"
  add_foreign_key "events", "venues"
  add_foreign_key "lineups", "artists"
  add_foreign_key "lineups", "events"
  add_foreign_key "messages", "chatrooms"
  add_foreign_key "messages", "devise"
  add_foreign_key "reviews", "events"
  add_foreign_key "reviews", "devise"
  add_foreign_key "rsvps", "events"
  add_foreign_key "rsvps", "devise"
end
